...
// values and teamMembers should be defined OUTSIDE the component
const values = [
  {
    icon: Target,
    title: "Excellence",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Delivering innovative HR solutions that transform businesses and
            empower people
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                sizes. We recognized that many companies struggled with complex
                HR challenges while lacking the resources for full-time HR
                departments.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Today, we&apos;ve grown into a trusted partner for over 500
                companies, helping them navigate recruitment, compliance,
                payroll, and employee engagement with confidence and expertise.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Excellence, integrity, and partnership form the foundation of
                  our relationships with clients and guide our commitment to
                  their success.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 sm:py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Let&apos;s discuss how we can help transform your HR operations and
